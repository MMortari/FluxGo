...
func (x *GetUserRequest) GetIdUser() string {
	if x != nil {
		return x.IdUser
	}
	return ""
...
const file_user_user_proto_rawDesc = "" +
	...
	"\aid_user\x18\x01 \x01(\tR\x06idUser\"1\n" +
	...
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB?Z=github.com/MMortari/FluxGo/example/full/shared/pb/user;userpbb\x06proto3"
